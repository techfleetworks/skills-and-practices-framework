...
const FIELD = [
  ...
  [/Tasks You Will Be Responsible/i, "Responsible Tasks"],
  [/^Accountable For$/i, "Accountable Tasks"],
  [/Consults In These Activities/i, "Consulted Tasks"],
  ...
  [/A Day in the Life/i, "A Day in the Life"],
